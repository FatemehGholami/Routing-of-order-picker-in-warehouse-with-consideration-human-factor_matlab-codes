...
for n=1:2:ncross
    ...
    p1=BinaryTournamentSelection(pop,[pop.F]);
    p2=BinaryTournamentSelection(pop,[pop.F]);
    
    [crosspop(n).Position,crosspop(n+1).Position]=SinglePointCrossover(p1.Position,p1.Position);
